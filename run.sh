...
CUDA_VISIBLE_DEVICES=0,1,2,3 PORT=295001 ./tools/dist_train.sh ./am_configs/reppoints.py 4 --work-dir './work_dirs/3.24_finch_4x_1_fpn1_12x4x16_sysu_prw_inria_cuhk'
#CUDA_VISIBLE_DEVICES=4,5,6,7 PORT=295002 ./tools/dist_train.sh ./am_configs/reppoints.py 4 --work-dir './work_dirs/3.24_finch_4x_1_fpn1_12x4x16_sysu_prw_inria_cuhk_1500'
