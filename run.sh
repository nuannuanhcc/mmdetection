...
CUDA_VISIBLE_DEVICES=0,1,2,3 PORT=295001 ./tools/dist_train.sh ./am_configs/reppoints.py 4 --work-dir './work_dirs/3.31_base_oim_m0.0'
#CUDA_VISIBLE_DEVICES=4,5,6,7 PORT=295002 ./tools/dist_train.sh ./am_configs/reppoints.py 4 --work-dir './work_dirs/3.31_base_oim_m0.5'
